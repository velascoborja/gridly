    ...
    months: [
      {
        ...
        personalRemaining: 0,
        additionalIncomes: [{ id: 1, monthId: 10, type: "income", label: "Freelance web", amount: 500, isRecurring: false, isCompleted: false, tagId: null, tag: null }],
        additionalExpenses: [{ id: 2, monthId: 10, type: "expense", label: "Cena cumpleaños", amount: 45, isRecurring: false, isCompleted: false, tagId: null, tag: null }],
        additionalExpenseGroups: [{
          id: 99, monthId: 10, label: "Viaje Roma", isCompleted: false, tagId: null, tag: null,
          entries: [{ id: 3, monthId: 10, type: "expense", label: "Vuelo Roma", amount: 200, isRecurring: false, isCompleted: false, tagId: null, tag: null }],
        }],
        recurringExpenses: [{ id: 4, monthId: 10, yearRecurringExpenseId: null, label: "Alquiler", amount: 900, sortOrder: 0, tagId: null, tag: null }],
...
test("filterSearchIndex sorts results by month ascending", () => {
  ...
  data.months.push({
    ...
    interests: 0, interestsManualOverride: false,
    personalRemaining: 0,
    additionalIncomes: [{ id: 5, monthId: 20, type: "income", label: "Freelance marzo", amount: 300, isRecurring: false, isCompleted: false, tagId: null, tag: null }],
    additionalExpenses: [],
    additionalExpenseGroups: [],
    recurringExpenses: [],
    totalIncome: 0, totalExpenses: 0, savings: 0, startingBalance: 0, endingBalance: 0,
